...
#To automatically create profile
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_active = models.BooleanField(
        ...
        default =True,
        help_text = ugettext_lazy('Designate whether this user should be treated as active. Unselected this instaed of deleting account')
